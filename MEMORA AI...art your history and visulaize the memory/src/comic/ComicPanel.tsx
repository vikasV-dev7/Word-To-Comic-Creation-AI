...
/* ─── Speech bubble ─── */
function SpeechBubble({ text, speakerName, panelWidth, panelHeight, speakerIsLeft, charScale, narratorOffset }: {
  text: string; speakerName: string
  panelWidth: number; panelHeight: number
  speakerIsLeft: boolean; charScale: number; narratorOffset: number
}) {
